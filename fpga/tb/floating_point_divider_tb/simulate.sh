...
vlog $INCLUDE_FLAGS -sv ../floating_point_divider_32_tb.sv | error_highlighter

export bindir=""

# -c argument gets name of testbench module.
vsim -c floating_point_divider_32_tb -suppress 8604 -do "run -all; quit" | error_highlighter
